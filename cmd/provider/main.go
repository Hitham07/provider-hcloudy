...
import (
	...
	"github.com/Hitham07/provider-hcloudy/apis"
	"github.com/Hitham07/provider-hcloudy/apis/v1alpha1"
	"github.com/Hitham07/provider-hcloudy/config"
	"github.com/Hitham07/provider-hcloudy/internal/clients"
	"github.com/Hitham07/provider-hcloudy/internal/controller"
	"github.com/Hitham07/provider-hcloudy/internal/features"
)

func main() {
	var (
		app                     = kingpin.New(filepath.Base(os.Args[0]), "Terraform based Crossplane provider for hcloudy").DefaultEnvars()
	...
	log := logging.NewLogrLogger(zl.WithName("provider-hcloudy"))
	if *debug {
	...
	mgr, err := ctrl.NewManager(cfg, ctrl.Options{
		...
		LeaderElectionID: "crossplane-leader-election-provider-hcloudy",
		Cache: cache.Options{
	...
	kingpin.FatalIfError(apis.AddToScheme(mgr.GetScheme()), "Cannot add hcloudy APIs to scheme")
	...
	kingpin.FatalIfError(controller.Setup(mgr, o), "Cannot setup hcloudy controllers")
